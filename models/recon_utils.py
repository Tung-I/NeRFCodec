# --- add these imports near the top of recon_utils.py ---
import av
import io
...
# (No filesystem, no subprocess: in-memory encode/decode via PyAV)

DCVC_ALIGN = 32
# =========================
# Core PyAV round-trip util
# =========================
def _pyav_roundtrip_bgr_one(
...
# =======================================
# HEVC (H.265 / libx265) — constant QP
# =======================================
