cd ../..
python train_ste.py --add_exp_version 1 --config configs/nerf_chair/chair_codec_ste_av1_qp28.txt \
...
python train_ste.py --add_exp_version 1 --config configs/nerf_chair/chair_codec_ste_av1_qp44.txt \
                --ckpt log/tensorf_chair_VM/tensorf_chair_VM.th\
                --batch_size 65536 \
                --codec_training \
                --lr_decay_target_ratio 1 \
...
python train_ste.py --add_exp_version 1 --config configs/nerf_chair/chair_codec_ste_av1_qp52.txt \
                --ckpt log/tensorf_chair_VM/tensorf_chair_VM.th\
                --batch_size 65536 \
                --codec_training \
                --lr_decay_target_ratio 1 \
...
#                 --codec_training \
#                 --lr_decay_target_ratio 1 \
#                 --wandb_project hevc_ste \
#                 --n_iters 8000 \
#                 --save_every 1000 --vis_every 1000
