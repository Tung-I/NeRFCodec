...
python train_ste.py --add_exp_version 1 --config configs/tt_family/family_codec_ste_jpeg50.txt \
...
python train_ste.py --add_exp_version 1 --config configs/tt_family/family_codec_ste_jpeg35.txt \
                --ckpt log/tensorf_family_VM/tensorf_family_VM.th\
                --compression --batch_size 65536 \
                --codec_training \
                --lr_decay_target_ratio 1 \
