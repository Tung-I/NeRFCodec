...
python train.py --add_exp_version 1 --expname bike_codec_384 \
                --config configs/bike_codec_384.txt --ckpt log/tensorf_bike_VM/tensorf_bike_VM.th\
...
python train.py --add_exp_version 1 --expname palace_codec_384 \
                --config configs/palace_codec_384.txt --ckpt log/tensorf_palace_VM/tensorf_palace_VM.th\
                --compression --render_test 1 --batch_size 65536 \
                --codec_training --compression_strategy adaptor_feat_coding \
                --lr_feat_codec 2e-4 --lr_aux 1e-3 \
                --fix_decoder_prior \
...
python train.py --add_exp_version 1 --expname robot_codec_384 \
                --config configs/robot_codec_384.txt --ckpt log/tensorf_robot_VM/tensorf_robot_VM.th\
                --compression --render_test 1 --batch_size 65536 \
                --codec_training --compression_strategy adaptor_feat_coding \
                --lr_feat_codec 2e-4 --lr_aux 1e-3 \
                --fix_decoder_prior \
                ...
                --lr_decay_target_ratio 1 \
                --warm_up \
                --warm_up_ckpt log/robot_codec_384/version_000 \
                --save_every 5000 --vis_every 5000

python train.py --add_exp_version 1 --expname spaceship_codec_384 \
                --config configs/spaceship_codec_384.txt --ckpt log/tensorf_spaceship_VM/tensorf_spaceship_VM.th\
                --compression --render_test 1 --batch_size 65536 \
                --codec_training --compression_strategy adaptor_feat_coding \
                --lr_feat_codec 2e-4 --lr_aux 1e-3 \
                --fix_decoder_prior \
                ...
                --lr_decay_target_ratio 1 \
                --warm_up \
                --warm_up_ckpt log/spaceship_codec_384/version_000 \
                --save_every 5000 --vis_every 5000

python train.py --add_exp_version 1 --expname steamtrain_codec_384 \
                --config configs/steamtrain_codec_384.txt --ckpt log/tensorf_steamtrain_VM/tensorf_steamtrain_VM.th\
                --compression --render_test 1 --batch_size 65536 \
                --codec_training --compression_strategy adaptor_feat_coding \
                --lr_feat_codec 2e-4 --lr_aux 1e-3 \
                --fix_decoder_prior \
...
python train.py --add_exp_version 1 --expname steamtrain_codec \
                ...
                --lr_decay_target_ratio 1 \
                --warm_up \
                --warm_up_ckpt log/steamtrain_codec/version_001 \
                --save_every 5000 --vis_every 5000
