...
python fix_train.py --add_exp_version 1 --expname chair_codec_fix_ep_384 \
                --config configs/nerf_chair/chair_codec_fix_ep_384.txt --ckpt log/tensorf_chair_VM/tensorf_chair_VM.th\
                --compression --render_test 1 --batch_size 65536 \
                --codec_training --compression_strategy adaptor_feat_coding \
                --lr_feat_codec 2e-4 --lr_aux 1e-3 \
                --fix_decoder_prior \
...
python fix_train.py --add_exp_version 1 --expname chair_codec_fix_cp_384 \
                --config configs/nerf_chair/chair_codec_fix_cp_384.txt --ckpt log/tensorf_chair_VM/tensorf_chair_VM.th\
                --compression --render_test 1 --batch_size 65536 \
                --codec_training --compression_strategy adaptor_feat_coding \
                --lr_feat_codec 2e-4 --lr_aux 1e-3 \
                --fix_decoder_prior \
