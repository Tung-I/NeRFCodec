...
class TanksTempleDataset(Dataset):
    ...
    def __init__(self, datadir, split='train', downsample=2.0, wh=[1920,1080], is_stack=False):
    ...
    def read_meta(self):
        ...
        # if self.free_view_video: # pose_trace op.
        #     poses = np.loadtxt(os.path.join(self.root_dir, 'test_traj_1.txt'))
        #     self.poses = torch.from_numpy(poses.reshape(-1, 4, 4))
        # else: # original op.
